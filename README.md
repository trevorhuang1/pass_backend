...
api/users:  These API's are guarded by @token_required, test these using Postman, first you must authenticate http://127.0.0.1:8086/api/users/authenticate using raw body JSON {"uid": "ThomasBaker", "password": "123ThomasBaker"} which will obtain a Cookie. Then you can use the API http://127.0.0.1:8086/api/users
